...
namespace CarRental.Migrations
{
    ...
    [Migration("20260226091318_AdditionalForTariff")]
    partial class AdditionalForTariff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarRental.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("PreviousRentalsCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarRental.Models.PriceTariff", b =>
                {
                    ...
                    b.ToTable("PriceTariffs");
                });

            modelBuilder.Entity("CarRental.Models.RentalContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarRental.Models.RentalContract", b =>
                {
                    ...
                    b.HasOne("CarRental.Models.ApplicationUser", "Client")
                        .WithMany("RentalContracts")
