...
namespace CarRental.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Въведете текуща парола.")]
            ...
            [StringLength(100, ErrorMessage = "Новата парола трябва да бъде поне 6 символа.", MinimumLength = 6)]
            [DataType(DataType.Password)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Потребителят потвърди паролата си успешно.");
